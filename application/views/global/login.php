						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Ticket</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Maguwoharjo International Stadium</h4>
							</div>
								...
								<div id="signup-box" class="signup-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<?php echo $this->session->flashdata('save_member'); ?>
											<div class="space-6"></div>
											<p> Enter your details to begin: </p>
											  ...
											  <?php echo form_open('web/cek_registrasi'); ?>
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															 <input type="text" name="phone" class="form-control" placeholder="Nomer Handphone" required="required"/>
