					...
					;?> 
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<?php
			echo '<a href="'.base_url().'member/pemesanan/'.$op['id_jadwal'].'" rel="example_group"  class="btn btn-xs btn-danger" role="button" <span>BUY NOW <i class="fa fa-shopping-cart" aria-hidden="true"></i></i><span></a>';
			?>
